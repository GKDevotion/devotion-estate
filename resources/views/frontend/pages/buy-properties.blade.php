                        ...
                        <select id="locationInput" name="location_id" class="form-select border-start-1">
                            ...
                            @forelse($locationObj as $p)
                                <option value="{{ $p->id ?? 'Unknown Location id' }}">
                                    {{ $p->name ?? 'Unknown Location' }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                    ...
                    <div class="dropdown property-type-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end p-3 shadow border-0" style="min-width: 300px;">
                            <div class="container-fluid p-0">
                                    ...
                                    <div class="tab-pane fade show active" id="pills-residential" role="tabpanel"
                                        ...
                                        <div class="row g-2">
                                            @forelse($residentialTypes as $type)
                                                <div class="col-6">
                                                    <button class="btn btn-outline-custom w-100 py-2 property-type-btn"
                                                        data-type="{{ $type->main_type }}" id="{{ $type->name }}">
                                                        {{ $type->name }}
                                                    </button>
                                                </div>
                                            @empty
                                ...
                                <div class="row g-2">
                                    <div class="col-6">
                                        <button class="btn btn-light border w-100 py-2" id="resetType">Reset</button>
                                    </div>
                                    <div class="col-6">
                                        <button class="btn btn-light border w-100 py-2" id="doneType">Done</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu p-3" style="min-width: 250px;">
                            ...
                            <div class="row g-2">
                                <div class="col-6">
                                    <button class="btn btn-light w-100 py-2">Reset</button>
                                </div>
                                <div class="col-6">
                ...
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu p-3" style="min-width: 250px;">
                            ...
                            <div class="row g-2">
                                <div class="col-6">
                                    <button type="reset" class="btn btn-light w-100 py-2"
                                        id="resetPrice">Reset</button>
                                </div>
                                <div class="col-6">
                                    <button type="submit" class="btn btn-light border w-100 py-2">Done</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                @forelse($properties as $p)
                    <div class="col-md-12 mb-4">
                        <a href="{{ route('property.detail', ['type' => $p->type == 0 ? 'sale' : 'rent', 'slug' => $p->slug]) }}"
                                            ...
                                            <div class="row align-items-start">
                                                ...
                                                <div class="col-4 text-end">
                                                    <img src="{{ asset('public/frontend/assets/images/Devotion Real Estate.png') }}"
                                                        alt="Estate Agent Logo" class="img-fluid"
                                                        style="max-width: 160px;">
                                                    <p class="small text-muted text-end mt-2 mb-0">Devotion Estate Agent
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
