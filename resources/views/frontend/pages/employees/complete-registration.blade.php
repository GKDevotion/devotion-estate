...
@section('title')
Complete {{$personInfo->first_name}} {{$personInfo->last_name}} Registration Process
@endsection
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-3">
            <div class="card">
                <div class="card-body" id="employeeRegistrationForm">
                    ...
                    <span class="employee-submit-url d-none">{{ route('complete-register', _en( $personInfo->id ) ) }}</span>
                    ...
                    <div class="form-header d-flex mb-4">
                        ...
                        <span class="stepIndicator">8. Family Doctor Info</span>
                        <span class="stepIndicator">9. Reference Info</span>
                    </div>
                    <!-- end step indicators -->
                    ...
                    <div class="step">
                        ...
                        <form autocomplete="off" id="employeeStepForm1" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <input type="hidden" value="1" name="step">
                            <input type="hidden" value="{{$personInfo->id}}" name="id" class="employee-id">
                                ...
                                <div class="col-md-6 offset-3">
                                    <div class="row form-footer d-flex">
                                        <div class="col-md-6 text-end">
                                            <button type="button" id="prevBtn" disabled onclick="nextPrev(-1, '')">
                                                <i class="fa fa-arrow-left"></i> Previous
                                            </button>
                                        </div>
                                        <div class="col-md-6">
                                            <button type="button" id="nextBtn" onclick="nextPrev(1, 'employeeStepForm1')">
                    ...
                    <div class="step">
                        ...
                        <form autocomplete="off" id="employeeStepForm2" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-12 mb-2">
                                    ...
                                    <select name="company_id" id="company_id" class="readonly form-control company-id get-department-list" data-id="department_id" data-required="yes">
                                        ...
                                        @foreach ($companyArr as $ar)
                                            <option value="{{ $ar->id }}" {{$personInfo->company_id ?? 0 == $ar->id ? 'selected' : ''}}>{{ $ar->name }}</option>
                                        @endforeach
                                    </select>
                                    <div class="error text-error"></div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-12 mb-2">
                                    ...
                                    <select name="department_id" id="department_id" class="readonly form-control department-id" data-required="yes">
                                        ...
                                        @foreach ($departmentArr as $ar)
                                            <option value="{{ $ar->id }}" {{$personInfo->department_id == $ar->id ? 'selected' : ''}}>{{ $ar->name }}</option>
                                        @endforeach
                                    </select>
                                    <div class="error text-error"></div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12 mb-2">
                                    ...
                                    <select name="job_role_id" id="job_role_id" class="readonly form-control job_role-id get-position-list" data-id="position_id" data-required="yes">
                                        ...
                                        @foreach ($jobRoleArr as $ar)
                                            <option value="{{ $ar->id }}" {{$personInfo->position->parent->id == $ar->id ? 'selected' : ''}}>{{ $ar->name }}</option>
                                        @endforeach
                                    </select>
                                    <div class="error text-error"></div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12 mb-2">
                                    ...
                                    <select name="position_id" id="position_id" class="readonly form-control" data-required="yes">
                                        ...
                                        @foreach ($positionArr as $ar)
                                            <option value="{{ $ar->id }}" {{$personInfo->position_id == $ar->id ? 'selected' : ''}}>{{ $ar->name }}</option>
                                        @endforeach
                                    </select>
                                    <div class="error text-error"></div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-12 mb-2">
                                    ...
                                    <select name="location_id" id="location_id" class="form-control" data-required="yes">
                                        <option value="0">Select Position</option>
                                        @foreach ($locationArr as $ar)
                                            <option value="{{ $ar->id }}" {{$personInfo->location_id ?? 0 == $ar->id ? 'selected' : ''}}>{{ $ar->display_name }}</option>
                                        @endforeach
                                    </select>
                                    <div class="error text-error"></div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-12 mb-2">
                                    ...
                                    <select name="employee_type_id" id="employee_type_id" class="readonly form-control employee-type-id" data-required="yes">
                                        ...
                                        @foreach ($employeeTypeArr as $ar)
                                            <option value="{{ $ar->id }}" {{$personInfo->personal_information->employee_type_id == $ar->id ? 'selected' : ''}}>{{ $ar->name }}</option>
                                        @endforeach
                                    </select>
                                    <div class="error text-error"></div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-12 mb-2">
                                    ...
                                    <input type="date" class="form-control" id="terminate_date" name="terminate_date" disabled value="{{$personInfo->personal_information->terminate_date ?? ''}}">
                                    <div class="error text-error"></div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-12 mb-2">
                                    ...
                                    <select name="payment_frequency_id" id="payment_frequency_id" class="readonly form-control payment-frequency-id" data-required="yes">
                                        ...
                                        @foreach ($payFrequencyArr as $ar)
                                            <option value="{{ $ar->id }}" {{$personInfo->personal_information->payment_frequency_id == $ar->id ? 'selected' : ''}}>{{ $ar->name }}</option>
                                        @endforeach
                                    </select>
                                    <div class="error text-error"></div>
                                </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6 offset-3">
                                    <div class="row form-footer d-flex">
                                        ...
                                        <div class="col-md-6">
                                            <button type="button" id="nextBtn" onclick="nextPrev(1, 'employeeStepForm2')">
                                                Next <i class="fa fa-arrow-right"></i>
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div class="step">
                        ...
                        <form autocomplete="off" id="employeeStepForm3" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <label class="mb-0" for="family_allowance">Housing Benefit</label>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6 offset-3">
                                    <div class="row form-footer d-flex">
                                        ...
                                        <div class="col-md-6">
                                            <button type="button" id="nextBtn" onclick="nextPrev(1, 'employeeStepForm3')">
                                                Next <i class="fa fa-arrow-right"></i>
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div class="step">
                        ...
                        <form autocomplete="off" id="employeeStepForm4" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-4 col-xl-4">
                                    ...
                                    <input type="file" class="avtar" data-default-file="{{asset( 'storage/'.$personInfo->avtar )}}" id="avtar" name="avtar" accept="image/jpg, image/jpeg, image/png" data-required="yes" >
                                    @if($errors->has('avtar'))
                                ...
                                <div class="col-12 col-lg-8 col-xl-8">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12 mb-2">
                                            <label class="mb-0" for="blood_group">Illness (if applicable)</label>
                                            <textarea class="form-control" id="illness" name="illness" placeholder="Describe any illness exist">{{$personInfo->personal_information->illness}}</textarea>
                                            <div class="error text-error"></div>
                                        </div>

                                        <div class="col-md-12 col-sm-12 mb-2">
                                            <label class="mb-0" for="other_details">Other Information ( Gardian Name, Mobile Number )</label>
                                            <textarea class="form-control" id="other_details" name="other_details" placeholder="Gardian Name, Mobile Number or any specific information">{{$personInfo->personal_information->other_details}}</textarea>
                                            <div class="error text-error"></div>
                                        </div>
                                        ...
                                        <div class="col-md-8 col-sm-12">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-12">
                                                    ...
                                                    <select name="continent_id" id="continent_id" class="form-control get-country-list continent-id" data-id="country_id" data-required="yes">
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    ...
                                                    <select name="country_id" id="country_id" class="form-control get-state-list country-id" data-id="state_id" data-required="yes" >
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    ...
                                                    <select name="state_id" id="state_id" class="form-control get-city-list state-id" data-id="city_id" data-required="yes" >
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    ...
                                                    <select name="city_id" id="city_id" class="form-control city-id" data-required="yes" >
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    ...
                                                    <input type="text" class="form-control mb-2" id="zipcode" name="zipcode" placeholder="Zipcode" value="{{$personInfo->employee_address->zipcode ?? ''}}" data-required="yes" >
                                                    <div class="error text-error"></div>
                                                </div>
                                                <div class="col-md-6 col-sm-12 permanent-address-checkbox-div">
                                                    <input type="checkbox" class="permanent-address-checkbox" id="checkbox" name="checkbox" {{ ($personInfo->employee_address->type ?? 0 ) == 1 ? 'checked' : ''}}>
                                                    <label class="mb-0" for="checkbox">Permanent Address</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6 offset-3">
                                    <div class="row form-footer d-flex">
                                        ...
                                        <div class="col-md-6">
                                            <button type="button" id="nextBtn" onclick="nextPrev(1, 'employeeStepForm4')">
                                                Next <i class="fa fa-arrow-right"></i>
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div class="step">
                        ...
                        <form autocomplete="off" id="employeeStepForm5" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-12">
                                    <label class="mb-0" for="branch_email_id">Bank Email </label>
                                    <input type="text" class="form-control mb-2" id="branch_email_id" name="branch_email_id" placeholder="Branch Email" value="{{$personInfo->bank_information->branch_email_id ?? ''}}">
                                </div>

                                <div class="col-md-3 col-sm-12">
                                    <label class="mb-0" for="branch_phone">Bank Phone </label>
                                    <input type="text" class="form-control mb-2" id="branch_phone" name="branch_phone" placeholder="Branch Phone" value="{{$personInfo->bank_information->branch_phone ?? ''}}">
                                </div>

                                <div class="col-md-9 col-sm-12">
                                    <label class="mb-0" for="address">Bank Full Address <span class="text-error">*</span></label>
                                    <input name="bank_address" id="bank_address" class="form-control bank-address" placeholder="Bank Full address" data-required="yes" value="{{$personInfo->bank_information->address ?? ''}}">
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6 offset-3">
                                    <div class="row form-footer d-flex">
                                        ...
                                        <div class="col-md-6">
                                            <button type="button" id="nextBtn" onclick="nextPrev(1, 'employeeStepForm5')">
                                                Next <i class="fa fa-arrow-right"></i>
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div class="step">
                        ...
                        <form autocomplete="off" id="employeeStepForm6" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="row" id="addSocialMediaPlatform">
                                ...
                                @foreach( $socialMedia as $sm )
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <input name="social_media[0][link]" id="link" class="form-control" value="" placeholder="Enter Social Media link">
                                        <div class="error text-error"></div>
                                    </div>
                                @endforeach
                            </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6 offset-3">
                                    <div class="row form-footer d-flex">
                                        ...
                                        <div class="col-md-6">
                                            <button type="button" id="nextBtn" onclick="nextPrev(1, 'employeeStepForm6')">
                                                Next <i class="fa fa-arrow-right"></i>
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div class="step">
                        ...
                        <form autocomplete="off" id="employeeStepForm7" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            ...
                            <fieldset class="p-2">
                                <legend class="d-none">Proof of Identity (POI):</legend>
                                <div class="row text-center">

                                    <!-- National ID Card -->
                                    <div class="col-3 col-sm-6 col-lg-3 mb-3">
                                    ...
                                    <!-- Voter ID Card -->
                                    <div class="col-3 col-sm-6 col-lg-3 mb-3 d-none">
                                        <div class="col-md-12 box-shadow-10 border-radius-15 mb-0">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6 offset-3">
                                    <div class="row form-footer d-flex">
                                        ...
                                        <div class="col-md-6">
                                            <button type="button" id="nextBtn" onclick="nextPrev(1, 'employeeStepForm7')">
                                                Next <i class="fa fa-arrow-right"></i>
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <!-- 8. Family Doctor Information -->
                    <div class="step">
                        <h3 class="text-center mb-4">Add your personal family doctor information</h3>
                        <form autocomplete="off" id="employeeStepForm8" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            ...
                            <fieldset>
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <label class="mb-0" for="family_doctor_name">Family Doctor Name<span class="text-error">*</span></label>
                                        <input type="text" class="form-control mb-2" id="family_doctor_name" name="family_doctor_name" placeholder="Family Doctor Name" value="{{$personInfo->doctor_information->doctor_name}}">
                                        <div class="error text-error"></div>
                                    </div>

                                    <div class="col-md-6 col-sm-12 mb-2">
                                        <label class="mb-0" for="doctor_contact_number">Doctor Contact Number<span class="text-error">*</span></label>
                                        <input type="text" class="form-control" id="doctor_contact_number" name="doctor_contact_number" placeholder="Contact Number" value="{{$personInfo->doctor_information->contact_number}}">
                                        <div class="error text-error"></div>
                                    </div>

                                    <div class="col-md-6 col-sm-12 mb-2">
                                        <label class="mb-0" for="clinic_name">Clinic Name<span class="text-error">*</span></label>
                                        <input type="text" class="form-control" id="clinic_name" name="clinic_name" placeholder="Clinic Name" value="{{$personInfo->doctor_information->clinic_name}}">
                                        <div class="error text-error"></div>
                                    </div>

                                    <div class="col-md-6 col-sm-12 mb-2">
                                        <label class="mb-0" for="clinic_address">Clinic Full Address<span class="text-error">*</span></label>
                                        <input type="text" class="form-control" id="clinic_address" name="clinic_address" placeholder="Clinic Address" value="{{$personInfo->doctor_information->address}}">
                                        <div class="error text-error"></div>
                                    </div>

                                    <div class="col-md-6 col-sm-12 mb-2">
                                        <label class="mb-0" for="body_checkup_report">Body Checkup Report</label>
                                        <input type="file" data-default-file="{{url( 'storage/'.$personInfo->doctor_information->body_checkup_report )}}" class="body_checkup_report" id="body_checkup_report" name="body_checkup_report" accept="image/jpg, image/jpeg, image/png, application/pdf">
                                    </div>

                                    <div class="col-md-6 col-sm-12 mb-2">
                                        <label class="mb-0" for="health_report">Health Report</label>
                                        <input type="file" data-default-file="{{url( 'storage/'.$personInfo->doctor_information->health_report )}}" class="health_report" id="health_report" name="health_report" accept="image/jpg, image/jpeg, image/png, application/pdf">
                                    </div>
                                </div>
                            </fieldset>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6 offset-3">
                                    <div class="row form-footer d-flex">
                                        ...
                                        <div class="col-md-6">
                                            <button type="button" id="nextBtn" onclick="nextPrev(1, 'employeeStepForm8')">
                                                Next <i class="fa fa-arrow-right"></i>
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <!-- 9. Refere's Information -->
                    <div class="step">
                        <h3 class="text-center mb-3">Refere's Information</h3>
                        <form autocomplete="off" id="employeeStepForm9" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <input type="hidden" value="9" name="step">
                            <input type="hidden" value="{{$personInfo->id}}" name="id" class="employee-id">
                            <input type="hidden" value="1" name="isRedirectThankYou">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6 offset-3">
                                    <div class="row form-footer d-flex">
                                        ...
                                        <div class="col-md-6">
                                            <button type="button" id="nextBtn" onclick="nextPrev(1, 'employeeStepForm9')">
                                                Next <i class="fa fa-arrow-right"></i>
                                            </button>
                                        </div>
                                    </div>
