...
@section('styles')
    ...
    <style>
        ...
        #employeeRegistrationForm .form-header .stepIndicator.finish::before {
        ...
        #employeeRegistrationForm input, #employeeRegistrationForm select {
            padding: 15px 20px;
            width: 100%;
            font-size: 1em;
        ...
        #employeeRegistrationForm input.invalid, #employeeRegistrationForm select.invalid, #employeeRegistrationForm textarea.invalid {
...
<div class="main-content-inner" id="grad1">
    <div class="row">
        <!-- data table start -->
                ...
                <div class="card-body pb-0">
                    ...
                    <form action="{{ route('complete-register', _en( $personInfo->id ) ) }}" method="POST" autocomplete="off" id="employeeRegistrationForm" enctype="multipart/form-data">
                        ...
                        <div class="form-header d-flex mb-4">
                            <span class="stepIndicator">1. Basic Information</span>
                            <span class="stepIndicator">2. Job Information</span>
                            <span class="stepIndicator">3. Benefit Information</span>
                            <span class="stepIndicator">4. Personal Information</span>
                            <span class="stepIndicator">5. Bank Information</span>
                            <span class="stepIndicator">6. Social Media</span>
                            <span class="stepIndicator">7. KYC Information</span>
                        </div>
                        <!-- end step indicators -->
                        ...
                        <!-- 6. Social Media -->
                        <div class="step">
                            <p class="text-center mb-4">Add your social media account information</p>
                        ...
                        <!-- 7. KYC Information -->
                        <div class="step">
                            <p class="text-center mb-4">Complete your KYC information</p>
                            <fieldset class="p-2">
