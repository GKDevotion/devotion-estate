    ...
    <div class="container my-5">
        ...
        <div class="row g-2 justify-content-center mb-4" style="padding-top: 60px">
            ...
            <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="custom-radio-box">
                    <input type="radio" class="btn-check" name="transaction-type" id="all" autocomplete="off"
                        checked>
        ...
        <div class="row align-items-center mb-3">
            <div class="col-md-8 properties-header">
                <h1 class="properties-title">Buy Luxury Properties in Dubai UAE</h1>
            ...
            <div class="col-md-4 text-md-end">
                <form method="GET" action="{{ route('luxury.properties') }}">
        ...
        <div class="row">
            @forelse($properties as $p)
                <div class="col-md-12 mb-4">
                    <a href="{{ route('property.detail', [ 'type' => $p->is_luxury_property == 1 ? 'luxury' : 'luxury','slug' => $p->slug ]) }}"
