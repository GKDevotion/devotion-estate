...
@section('content')
   ...
   <div class="main-heading">
    <h1 class="text-center title mb-5 pt-5">Terms and Conditions</h1>
  </div>
  <div class="container content-section">
    <div class="row justify-content-center">
      <div class="col-lg-10 content-container">
        <p class="mb-4">
          Welcome to Devotion Estate!
        </p>
        <p class="mb-4">
          These terms and conditions outline the rules and regulations for the use of Devotion Estate's Website, located
          at https://devotionestate.com/.
        </p>
        <p class="mb-4">

          By accessing this website we assume you accept these terms and conditions. Do not continue to use Devotion
          Estate if you do not agree to take all of the terms and conditions stated on this page.
        </p>
        <p class="mb-4">
          ...
          <a href="#" target="_blank" class=" text-decoration-none" style="color: #aa8038;">
        ...
        <h2 class="text-start mb-4 main-heading-2 pt-3">Cookies</h2>
        <p class="mb-3 ">
          We employ the use of cookies. By accessing Devotion Estate, you agreed to use cookies in agreement with the
          Devotion Estate's Privacy Policy.
        </p>
        <p class="mb-3">
        ...
        <h2 class="text-start mb-4 main-heading-2 pt-3">License</h2>

        <p class="mb-3 text-secondary" style="font-size: 1rem;">
          Unless otherwise stated, Devotion Estate and/or its licensors own the intellectual property rights for all
          material on Devotion Estate. All intellectual property rights are reserved. You may access this from Devotion
          Estate for your own personal use subjected to restrictions set in these terms and conditions.
        </p>
        <div class="col-lg-5 small pl-5" style="color: #575a7b;">
          <h5 class="text-start mb-3" style="font-size: medium; font-weight: normal;">
            You must not:</h5>
          <ul class="list-bullet">
            <li class="mb-2">Republish material from Devotion Estate</li>
            <li class="mb-2">Sell, rent or sub-license material from Devotion Estate</li>
            <li class="mb-2">Reproduce, duplicate or copy material from Devotion Estate</li>
            <li class="mb-2">Redistribute content from Devotion Estate</li>
          </ul>
        </div>
        <p class="mb-3">
        ...
        <p class="mb-3">
          ...
          areas of the website. Devotion Estate does not filter, edit, publish or review Comments prior to their
          presence on the website. Comments do not reflect the views and opinions of Devotion Estate,its agents and/or
          affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the
          extent permitted by applicable laws, Devotion Estate shall not be liable for the Comments or for any
        ...
        <p class="mb-3">
          ...
          Devotion Estate reserves the right to monitor all Comments and to remove any Comments which can be considered
          inappropriate, offensive or causes breach of these Terms and Conditions.
        </p>

        <div class="col-lg-5 small pl-5" style="color: #575a7b;">
          <h5 class="text-start mb-3" style="font-size: medium; font-weight: normal;">
            You warrant and represent that:</h5>
          <ul class="list-bullet">
            <li class="mb-2">You are entitled to post the Comments on our website and have all necessary licenses and
              consents
              to do so;</li>
            <li class="mb-2">The Comments do not invade any intellectual property right, including without limitation
              copyright,
              patent or trademark of any third party;</li>
            <li class="mb-2">The Comments do not contain any defamatory, libelous, offensive, indecent or otherwise
              unlawful
              material which is an invasion of privacy</li>
            <li class="mb-2">The Comments will not be used to solicit or promote business or custom or present
              commercial
        ...
        <p class="mb-3">
          You hereby grant Devotion Estate a non-exclusive license to use, reproduce, edit and authorize others to use,
          reproduce and edit any of your Comments in any and all forms, formats or media.
        </p>

        <h2 class="text-start mb-4 main-heading-2 pt-3">Hyperlinking to our Content</h2>
        ...
        <ul class="list-bullet">
          ...
          <li class="mb-2">Online directory distributors may link to our Website in the same manner as they hyperlink to
            the Websites of other listed businesses; and
          </li>
          <li class="mb-2"> System wide Accredited Businesses except soliciting non-profit organizations, charity
        ...
        <ul class="list-bullet">
          ...
          <li class="mb-2">dot.com community sites;</li>
          <li class="mb-2">associations or other groups representing charities;</li>
          <li class="mb-2">online directory distributors;
          </li>
          <li class="mb-2"> internet portals;
          </li>
          <li class="mb-2"> accounting, law and consulting firms; and
          </li>
          <li class="mb-2">educational institutions and trade associations.
          </li>
        ...
        <p class="mb-3">
          ...
          Devotion Estate; and (d) the link is in the context of general resource information.
        </p>
        ...
        <p class="mb-3">
          ...
          you must inform us by sending an e-mail to Devotion Estate. Please include your name, your organization name,
        ...
        <ul class="list-bullet">
          ...
          <li class="mb-2">By use of any other description of our Website being linked to that makes sense within the
            context and format of content on the linking party's site.</li>
        </ul>
        <p class="mb-3">
          No use of Devotion Estate's logo or other artwork will be allowed for linking absent a trademark license
          agreement.
        </p>


        <h2 class="text-start mb-4 main-heading-2 pt-3">iFrames</h2>
        ...
        <h2 class="text-start mb-4 main-heading-2 pt-3">Content Liability</h2>
        <p class="mb-3">
        ...
        <h2 class="text-start mb-4 main-heading-2 pt-3">Reservation of Rights</h2>
        ...
        <h2 class="text-start mb-4 main-heading-2 pt-3">Removal of links from our website</h2>
        ...
        <h2 class="text-start mb-4 main-heading-2 pt-3">Disclaimer</h2>
        ...
        <ul class="list-bullet">
          ...
          <li class="mb-2">limit any of our or your liabilities in any way that is not permitted under applicable law;
            or</li>
