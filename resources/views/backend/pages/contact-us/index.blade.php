        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left d-none"> Contact Us</h4>
                    <ul class="breadcrumbs pull-left m-2">
                        <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                        <li><span>All Contact Us</span></li>
                    </ul>
                </div>
            </div>
            {{-- <div class="col-md-2 text-end">
                @if (Auth::guard('admin')->user()->can('property-contact.create'))
                    <a class="btn btn-add text-white" href="{{ route('admin.contact-us.create') }}">
    ...
    <div class="main-content-inner">
        <div class="row">
            ...
            <div class="col-12 mt-3">
                <h3 class="pb-3">Contact Us Hisotry</h3>
                <div class="card">
                    <div class="card-body">
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            var table = $('#contact-us_index').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                ...
                pageLength: 10,
                ajax: {
                    url: "{{ route('contact-us.ajaxIndex') }}",
                    type: 'GET',
                    data: function(d) {
                ...
                createdRow: function(row, data, dataIndex) {
                    ...
                    $(row).attr('class', 'contact-us_row'); // Assign a custom Class to the row
                },
                language: {
            ...
            table.on('xhr', function() {
                ...
                $('#contact-us_index').css('width', '100%');
            });
        });
    </script>
@endsection
