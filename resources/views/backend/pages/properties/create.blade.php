                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12 mb-2">
                                        ...
                                        <input type="text" class="form-control mb-2" data-required="yes" id="name" name="name" placeholder="Property Name/Title" value="">
                                        <div class="error text-error"></div>
                                    </div>

                                    <div class="col-md-6 col-sm-12 mb-2">
                                        <label class="mb-0" for="h1_tag">H1 Tag <span class="text-error">*</span></label>
                                        <input type="text" class="form-control mb-2" data-required="yes" id="h1_tag" name="h1_tag" placeholder="H1 tag" value="">
                                        <div class="error text-error"></div>
                                    </div>

                                    <div class="col-md-6 col-sm-12 mb-2">
                                        <label class="mb-0" for="seo_title">SEO Title <span class="text-error">*</span></label>
                                        <input type="text" class="form-control mb-2" data-required="yes" id="seo_title" name="seo_title" placeholder="Property SEO Title" value="">
                                        <div class="error text-error"></div>
                                    </div>

                                    <div class="col-md-6 col-sm-12 mb-2">
                                        <label class="mb-0" for="meta_description">Meta Desccription <span class="text-error">*</span></label>
                                        <input type="text" class="form-control mb-2" data-required="yes" id="meta_description" name="meta_description" placeholder="SEO Meta Description" value="">
                                        <div class="error text-error"></div>
                                    </div>

                                    <div class="col-md-12 col-sm-12 mb-2">
                                        <label class="mb-0" for="description">Desccription <span class="text-error">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-12 mb-2">
                                        ...
                                        <select name="purpose" id="purpose" class="form-control" data-required="yes">
                                    ...
                                    <div class="col-md-4 col-sm-12 mb-2">
                                        ...
                                        <select name="type" id="type" class="form-control" data-required="yes">
                                    ...
                                    <div class="col-md-4 col-sm-12 mb-2">
                                        ...
                                        <select name="sub_type_id" id="sub_type_id" class="form-control" data-required="yes">
                                            <option value="0">Select Sub Type</option>
                                            @foreach ( $propertyTypeObj as $ar )
                                                <option value="{{$ar->id}}" class="show-{{$ar->main_type}} default-sub-type-hide d-none">{{$ar->name}}</option>
                                            @endforeach
                                        </select>
                                        <div class="error text-error"></div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-sm-12 mb-2">
                                        ...
                                        <select name="is_furnish" id="is_furnish" class="form-control" data-required="yes">
                                    ...
                                    <div class="col-md-4 col-sm-12 mb-2 purpose-for-sale">
                                        ...
                                        <select name="is_complete" id="is_complete" class="form-control" data-required="yes">
                                    ...
                                    <div class="col-md-4 col-sm-12 mb-2">
                                        ...
                                        <select name="ownership_status" id="ownership_status" class="form-control" data-required="yes">
                                   ...
                                   <div class="col-md-4 col-sm-12 mb-2 d-none is-complete-offplan">
                                       ...
                                       <input type="date" class="form-control mb-2" data-required="yes" id="completed_date" name="completed_date" placeholder="Expected Completed Date" value="">
                                       <div class="error text-error"></div>
                                   </div>
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-12 mb-2">
                                        <label class="mb-0" for="price"><span class="purpose-type-txt">Sale</span>(AED) <span class="text-danger">(All Inclusive)</span> <span class="text-error">*</span></label>
                                        <input type="text" class="form-control mb-2" data-required="yes" id="price" name="price" placeholder="Enter Amount" value="">
                                        <div class="error text-error"></div>
                                    </div>
                                    ...
                                    <div class="col-md-2 col-sm-12 mb-2 purpose-type-sale">
                                        ...
                                        <select name="is_finance_available" id="is_finance_available" class="form-control" data-required="yes">
                                    ...
                                    <div class="col-md-5 col-sm-12 mb-2 purpose-type-sale">
                                        ...
                                        <input type="text" class="form-control mb-2" data-required="" id="finance_name" name="finance_name" placeholder="Finance Intitute Name" value="">
                                        <div class="error text-error"></div>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-12 mb-2 d-none purpose-type-rent">
                                        ...
                                        <select name="rent_frequency" id="rent_frequency" class="form-control" data-required="yes">
                                    ...
                                    <div class="col-md-3 col-sm-12 mb-2 d-none purpose-type-rent">
                                        ...
                                        <input type="text" class="form-control mb-2" data-required="yes" id="rent_contract_period" name="rent_contract_period" placeholder="Minimum Contract Period (Months)" value="">
                                        <div class="error text-error"></div>
                                    </div>

                                    <div class="col-md-3 col-sm-12 mb-2 d-none purpose-type-rent">
                                        <label class="mb-0" for="rent_notice_period">Vacating Notice Period (Months) <span class="text-error">*</span></label>
                                        <input type="text" class="form-control mb-2" data-required="yes" id="rent_notice_period" name="rent_notice_period" placeholder="Vacating Notice Period (Months)" value="">
                                        <div class="error text-error"></div>
                                    </div>

                                    <div class="col-md-3 col-sm-12 mb-2 d-none purpose-type-rent">
                                        <label class="mb-0" for="maintenance_fees">Maintenance Fee (AED) <span class="text-error">*</span></label>
                                        <input type="text" class="form-control mb-2" data-required="yes" id="maintenance_fees" name="maintenance_fees" placeholder="Maintenance Fee (AED)" value="">
                                        <div class="error text-error"></div>
                                    </div>

                                    <div class="col-md-3 col-sm-12 mb-2 d-none purpose-type-rent">
                                        <label class="mb-0" for="maintenance_paid">Maintenance Paid By <span class="text-error">*</span></label>
                                        <select name="maintenance_paid" id="maintenance_paid" class="form-control" data-required="yes">
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-12 mb-2">
                                        ...
                                        <input type="text" class="form-control mb-2" data-required="yes" id="area" name="area" placeholder="Area (Square Feet.)" value="">
                                        <div class="error text-error"></div>
                                    </div>

                                    <div class="col-md-4 col-sm-12 mb-2">
                                        <label class="mb-0" for="rera_number">RERA Number <span class="text-error">*</span></label>
                                        <input type="text" class="form-control mb-2" data-required="yes" id="rera_number" name="rera_number" placeholder="Rera Number" value="">
                                        <div class="error text-error"></div>
                                    </div>

                                    <div class="col-md-4 col-sm-12 mb-2">
                                        <label class="mb-0" for="permit_number">Permit Number <span class="text-error">*</span></label>
                                        <input type="text" class="form-control mb-2" data-required="yes" id="permit_number" name="permit_number" placeholder="Permit Number" value="">
                                        <div class="error text-error"></div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-sm-12 mb-2">
                                        ...
                                        <select name="agent_id" id="agent_id" class="form-control" data-required="yes">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6 offset-3">
                                    <div class="row form-footer d-flex">
                                        ...
                                        <div class="col-md-6">
                                            <button type="button" id="nextBtn" onclick="nextPrev(1, 'PropertyStepForm1')">
                                    ...
                                    @foreach( getPropertyFeatures() as $ar )
                                        <div class="col-md-3 col-sm-12">
                                            <li class="child-nested">
                                                <input type="checkbox" class="form-check-input" name="feature_id[]" id="property_feature_{{ $ar->id }}" value="{{ $ar->id }}">
                                                <label class="mb-0 form-check-label" for="property_feature_{{ $ar->id }}" oninput="trackChanges()">{{ $ar->name }}</label>
                                            </li>
                                        </div>
                                    @endforeach
                                </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6 offset-3">
                                    <div class="row form-footer d-flex">
                                        ...
                                        <div class="col-md-6">
                                            <button type="button" id="nextBtn" onclick="nextPrev(1, 'PropertyStepForm2')">
                                                Next <i class="fa fa-arrow-right"></i>
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div class="step">
                        ...
                        <form autocomplete="off" id="PropertyStepForm3" enctype="multipart/form-data">
                            ...
                            <div class="row box-shadow-10">
                                <div class="col-md-4 col-sm-12 mb-2">
                                    ...
                                    <input type="file" class="property_image" id="property_image" name="propertyImage[]" accept="image/jpg, image/jpeg, image/png" multiple>
                                    @if($errors->has('avtar'))
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6 offset-3">
                                    <div class="row form-footer d-flex">
                                        ...
                                        <div class="col-md-6">
                                            <button type="button" id="nextBtn" onclick="nextPrev(1, 'PropertyStepForm3')">
                                                Next <i class="fa fa-arrow-right"></i>
                                            </button>
                                        </div>
                                    </div>
                        ...
                        <div class="thank-you-page d-none">
                            <div class="properties-thank-you-content">
                                ...
                                <p>Property has been added successfully and ID is: <snap style="font-weight: 800;" class="property-unique-id"></snap></p>
                            </div>
                            <div class="row">
