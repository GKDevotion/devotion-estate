        ...
        <div class="row align-items-center">
            <div class="col-md-7">
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left d-none">Award Edit - {{ $data->name }}</h4>
            ...
            <div class="col-md-3">
                <p class="float-end">
                    @if (Auth::guard('admin')->user()->can('award.edit'))
    ...
    <div class="main-content-inner">
        <div class="row">
            ...
            <div class="col-12 mt-3">
                <h3 class="pb-3">Update Award</h3>
                <div class="card">
                    <div class="card-body">

                        <form action="{{ route('admin.award.update', $data->id) }}" enctype="multipart/form-data"
