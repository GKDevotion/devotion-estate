    ...
    <div class="row align-items-center">
        <div class="col-sm-7">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left d-none">Property Types</h4>
        ...
        <div class="col-md-3 text-end">
            @if (Auth::guard('admin')->user()->can('property-types.create'))
                <a class="btn btn-add text-white" href="{{ route('admin.property-types.create') }}">
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-3">
            <h3 class="pb-3">Property Types History</h3>
            <div class="card">
                <div class="card-body">
    ...
    @include('backend.layouts.partials.data-table')
     ...
     <script>
        $(document).ready(function() {
            var table = $('#property-types_index').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
