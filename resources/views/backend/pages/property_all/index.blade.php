        ...
        <div class="row align-items-center">
            <div class="col-sm-7">
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left d-none">Property All</h4>
                    <ul class="breadcrumbs pull-left m-2">
                        <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                        <li><span>All Property Features</span></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-3 text-end">
                @if (Auth::guard('admin')->user()->can('property-all.create'))
                    <a class="btn btn-add text-white" href="{{ route('admin.property-all.create') }}">
                        <i class="fa fa-plus"></i> Property Types
                    </a>
                @endif
            </div>
    ...
    <div class="main-content-inner">
        <div class="row">
            ...
            <div class="col-12 mt-3">
                <h3 class="pb-3">Property All History</h3>
                <div class="card">
                    <div class="card-body">
...
@section('scripts')
    ...
    {{-- <script>
        $(document).ready(function() {
            var table = $('#property-all').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                ...
                pageLength: 10,
                ajax: "{{ route('property-all.ajaxIndex') }}",
                columns: [
                    {
                        data: 'id',
            ...
            table.on('xhr', function() {
                ...
                if (data.length === 0) {
                    $('#Property All_index').css('width', '100%');
                } else {
                    $('#Property All_index').css('width', 'auto');
                }
            });
        });
     </script> --}}
