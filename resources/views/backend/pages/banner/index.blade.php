    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-3 text-end">
            @if (Auth::guard('admin')->user()->can('banner.create'))
                <a class="btn btn-add text-white" href="{{ route('admin.banner.create') }}">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="data-tables">
                        ...
                        <table id="banner_index" class="table table-bordered table-striped display responsive nowrap">
                            <thead id="banner" class="bg-light text-capitalize">
                                <tr>
                                    <th width="1%">Sr</th>
                                    <th width="5%">image</th>
                                    <th width="5%">Title</th>
