...
@section('title')
    Company Payment Plan Edit - Admin Panel
@endsection
        ...
        <div class="row align-items-center">
            <div class="col-md-7">
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left d-none">Payment Plan Edit - {{ $data->name }}</h4>
    ...
    <div class="main-content-inner">
        <div class="row">
            ...
            <div class="col-12 mt-3">
                <h3 class="pb-3">Update Payment Plan</h3>
                <div class="card">
                    <div class="card-body">

                        <form action="{{ route('admin.payment-plan.update', $data->id) }}" method="POST">
                            @method('PUT')
                            @csrf
                            <div class="row">
    ...
    <div class="modal fade" id="editpaymentPlanModal" tabindex="-1" aria-labelledby="paymentPlanModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.payment-plan.update') }}" onsubmit="return onSubmitValidateForm();"
                                ...
                                <div class="col-md-12 m-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name"
                                            value="{{ $data->name }}" placeholder="Enter value (e.g. 98 - 60%)"
                                            pattern="[0-9+\-*/%(). ]+"
