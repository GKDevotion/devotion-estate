        ...
        <div class="row align-items-center">
            <div class="col-md-7">
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left d-none">Property Add</h4>
                    <ul class="breadcrumbs pull-left m-2">
                        <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                        <li><a href="{{ route('admin.property-types.index') }}">Add Property</a></li>
            ...
            <div class="col-12 mt-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.property-add.store') }}" onsubmit="return onSubmitValidateForm();"
                            method="POST" autocomplete="off">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">

                                    <div class="form-step form-step-active" id="step-content-1">
                                        <div class="row">
                                            <!-- Step Progress Bar -->
                                            <div class="stepper-wrapper mb-4">
                                                ...
                                                <div class="stepper-item" id="step2">
                                                    ...
                                                    <div class="step-name">FEATURE(S)</div>
                                                </div>
                                            ...
                                            <div class="col-md-6 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" data-required="yes" class="form-control"
                                                        id="unique_code" name="unique_code" placeholder="unique_code"
                                                        autofocus>
                                                </div>
                                                @error('unique_code')
                                            ...
                                            <div class="col-md-6 mb-2">
                                                <div class="form-group">
                                                    <label class="mb-0" for="h1_tag">H1 Tag<span
                                                            class="text-error">*</span></label>
                                                    <input type="text" data-required="yes" class="form-control"
                                                        id="h1_tag" name="h1_tag"
                                                        placeholder="H1 Tag Property Name/Title" autofocus>
                                                </div>
                                                @error('h1_tag')
                                                    <div class="error text-error">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="col-md-6 mb-2">
                                                <div class="form-group">
                                                    <label class="mb-0" for="slug">Slug<span
                                                            class="text-error">*</span></label>
                                                    <input type="text" data-required="yes" class="form-control"
                                                        id="slug" name="slug" placeholder="" autofocus>
                                                </div>
                                                @error('slug')
                                                    <div class="error text-error">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="col-md-12 mb-2">
                                                <div class="form-group">
                                                    <label class="mb-0" for="meta_description">Meta Description<span
                                                            class="text-error">*</span></label>
                                                    <input type="text" data-required="yes" class="form-control"
                                                        id="meta_description" name="meta_description" placeholder=""
                                                        autofocus>
                                                </div>
                                                @error('slug')
                                                    <div class="error text-error">{{ $message }}</div>
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group">
                                                    <label class="mb-0" for="property_purpose">Purpose <span
                                                            class="text-error">*</span></label>
                                                    <select class="form-control" id="property_purpose"
                                                        name="property_purpose" data-required="yes">
                                                        <option value="">Select Purpose Of Property</option>
                                                        <option value="0"
                                                            {{ old('property_purpose') == '0' ? 'selected' : '' }}>
                                                            For Sell</option>
                                                        <option value="1"
                                                            {{ old('property_purpose') == '1' ? 'selected' : '' }}>
                                                            For Rent</option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="property_type" name="property_type"
                                                        ...
                                                        <option value="0"
                                                            {{ old('property_type') == '0' ? 'selected' : '' }}>
                                                            Residential</option>
                                                        <option value="1"
                                                            {{ old('property_type') == '1' ? 'selected' : '' }}>
                                                            Commercial</option>
                                                    </select>
                                                </div>
                                                @error('property_type')
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group">
                                                    <label class="mb-0" for="property_sub_type">Sub Type <span
                                                            class="text-error">*</span></label>
                                                    <select class="form-control" id="property_sub_type"
                                                        name="property_sub_type" data-required="yes">
                                                    ...
                                                    <div class="d-flex justify-content-center gap-5 mt-3">
                                                        ...
                                                        <div class="text-center">
                                                            <input class="form-check-input" type="radio"
                                                                name="furnished_status" id="furnished_yes" value="1"
                                                        ...
                                                        <div class="text-center">
                                                            <input class="form-check-input" type="radio"
                                                                name="furnished_status" id="furnished_no" value="0"
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group text-center">
                                                    ...
                                                    <div class="d-flex justify-content-center gap-5 mt-3">
                                                        ...
                                                        <div class="text-center">
                                                            <input class="form-check-input" type="radio"
                                                                name="completion_status" id="completion_yes"
                                                                value="1"
                                                        ...
                                                        <div class="text-center">
                                                            <input class="form-check-input" type="radio"
                                                                name="completion_status" id="completion_no"
                                                                value="0"
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group text-center">
                                                    ...
                                                    <div class="d-flex justify-content-center gap-5 mt-3">
                                                        ...
                                                        <div class="text-center">
                                                            <input class="form-check-input" type="radio"
                                                                name="ownership_status" id="ownership_yes" value="1"
                                                        ...
                                                        <div class="text-center">
                                                            <input class="form-check-input" type="radio"
                                                                name="ownership_status" id="ownership_no" value="0"
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" data-required="yes" class="form-control"
                                                        id="price" name="price" placeholder="Price(AED)"
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="financing_available"
                                                        name="financing_available" data-required="yes">
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" data-required="yes" class="form-control"
                                                        ...
                                                        placeholder="Finance Institute" min="0" step="1"
                                                        autofocus>
                                            ...
                                            <div class="col-md-4 mb-2">
                                                <div class="form-group">
                                                    <label class="mb-0" for="rera_number">RERA Number<span
                                                            class="text-error">*</span></label>
                                                    <input type="number" data-required="yes" class="form-control"
                                                        id="rera_number" name="rera_number" placeholder="RERA No."
                                                        min="0" step="1" autofocus>
                                                    ...
                                                    <div class="col-md-8 mb-2">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="mb-0" for="address">Address <span
                                                                    class="text-error">*</span></label>
                                                            <input type="text" data-required="yes"
                                                    ...
                                                    <div class="col-md-4 mb-2">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="mb-0" for="list_owner">List Owner <span
                                                                    class="text-error">*</span></label>
                                                            <select class="form-control" id="list_owner"
                                                                name="list_owner" data-required="yes">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-12 d-flex justify-content-between">
                                            <button type="button" class="btn btn-secondary"
                                                id="prevBtn2">Previous</button>
                                            <button type="button" class="btn btn-success" id="nextBtn2">Next</button>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 mb-3">
                                                        <label for="propertyImages" class="form-label">Upload File</label>
                                                        ...
                                                        <div class="dropzone-wrapper border p-5 text-center rounded position-relative"
                                                            ...
                                                            <div class="dropzone-desc">
                                                                <i class="fa-solid fa-cloud-arrow-down fa-2xl mb-3"></i>
                                                                <!-- FA6 free -->
            ...
            <script>
                ...
                function showStep(step) {
                    document.querySelectorAll('.form-step').forEach((el, index) => {
                        ...
                        if (index + 1 === step) el.classList.add('form-step-active');
                    });
