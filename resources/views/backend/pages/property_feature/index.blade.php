    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-3 text-end">
            @if (Auth::guard('admin')->user()->can('property-features.create'))
                <a class="btn btn-add text-white" href="{{ route('admin.property-features.create') }}">
                    <i class="fa fa-plus"></i> Property Features
                </a>
            @endif
        </div>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-3">
            <h3 class="pb-3">Property Features History</h3>
            <div class="card">
                <div class="card-body">
    ...
    @include('backend.layouts.partials.data-table')
     ...
     <script>
        $(document).ready(function() {
            var table = $('#property-features_index').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                ...
                pageLength: 10,
                ajax: "{{ route('property-features.ajaxIndex') }}",
                columns: [
                    {
                        data: 'id',
