    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-3 text-end">
            @if (Auth::guard('admin')->user()->can('clients.edit'))
                <a class="btn btn-add text-white" href="{{ route('admin.clients.create') }}">
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-3">
            <h3 class="pb-3">Client History</h3>
            <div class="card">
                <div class="card-body">
                    <div class="data-tables">
                        @include('backend.layouts.partials.messages')
                        <table id="client_index" class="table table-bordered table-striped display responsive nowrap">
     ...
     <script>
        $(document).ready(function() {
            var table = $('#client_index').DataTable({
                ...
                pageLength: 10,
                ajax: "{{ route('clients.ajaxIndex') }}",
                // ajax: {
                //     url: "{{ route('clients.ajaxIndex' ) }}",
                //     type: 'GET',
                //     data: function (d) {
