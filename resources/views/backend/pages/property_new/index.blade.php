            ...
            <div class="col-sm-7">
                <div class="breadcrumbs-area clearfix">
                    ...
                    <ul class="breadcrumbs pull-left m-2">
                        ...
                        <li><span>All Property New</span></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-3 text-end">
                @if (Auth::guard('admin')->user()->can('property-new.create'))
                    <a class="btn btn-add text-white" href="{{ route('admin.property-new.create') }}">
                        <i class="fa fa-plus"></i> Property New
                    </a>
                @endif
            </div>
    ...
    <div class="main-content-inner">
        <div class="row">
            ...
            <div class="col-12 mt-3">
                <h3 class="pb-3">Property New History</h3>
                <div class="card">
                    <div class="card-body">
