    ...
    <div class="row align-items-center">
        <div class="col-sm-7">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left d-none">Status</h4>
                <ul class="breadcrumbs pull-left m-2">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li><span>All Statuses</span></li>
                </ul>
            </div>
        </div>
        <div class="col-md-3 text-end">
            @if (Auth::guard('admin')->user()->can('project-status.edit'))
                <a class="btn btn-add text-white" href="{{ route('admin.project-status.create') }}">
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-3">
            <h3 class="pb-3">Project Status</h3>
            <div class="card">
                <div class="card-body">
                        ...
                        <table id="dataTable" class="text-center" style="width: 100%">
                            ...
                            <tbody>
                                @foreach ($dataArr as $data)
                                    <tr id="row_{{$data->id}}" class="projectStatus_row">
                                        <td>{{ $loop->index+1 }}</td>
                                        <td class="text-left">
                                            {{$data->name}}
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="action_menu_{{$data->id}}">
                                                ...
                                                @if (Auth::guard('admin')->user()->can('project-status.edit'))
                                                    <a class="btn btn-edit text-white dropdown-item" href="{{ route('admin.project-status.edit', $data->id) }}">
                                                        <i class="fa fa-pencil"></i> Edit
                                                    </a>
                                                @endif

                                                @if (Auth::guard('admin')->user()->can('project-status.delete'))
                                                    <button class="btn btn-edit text-white delete-record dropdown-item" data-id="{{$data->id}}" data-title="{{ $data->name }}" data-segment="project-status">
