...
@section('title')
Project Status Edit - Admin Panel
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-7">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left d-none">Project Status Edit - {{ $data->name }}</h4>
                <ul class="breadcrumbs pull-left m-2">
                <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li><a href="{{ route('admin.project-status.index') }}">All Status</a></li>
                    <li><span>Edit Project Status</span></li>
                </ul>
            </div>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-12 mt-3">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.project-status.update', $data->id) }}" onsubmit="return onSubmitValidateForm();" method="POST">
                        @method('PUT')
                        @csrf
