...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-3">
            <h3 class="pb-3">Agent History</h3>
            <div class="card">
                <div class="card-body">
                    <div class="data-tables">
                        @include('backend.layouts.partials.messages')
                        <table id="agent_index" class="table table-bordered table-striped display responsive nowrap">
    ...
    @include('backend.layouts.partials.data-table')
     ...
     <script>
        $(document).ready(function() {
            var table = $('#agent_index').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                ...
                pageLength: 10,
                ajax: "{{ route('agents.ajaxIndex') }}",
                // ajax: {
                //     url: "{{ route('agents.ajaxIndex' ) }}",
                //     type: 'GET',
                //     data: function (d) {
            ...
            table.on('xhr', function() {
                ...
                if (data.length === 0) {
                    $('#agent_index').css('width', '100%');
                } else {
                    $('#agent_index').css('width', 'auto');
                }
            });
        });
