        ...
        <div class="col-sm-7">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left m-2">
                    ...
                    <li><span>All Owners</span></li>
                </ul>
            </div>
        </div>
        <div class="col-md-3 text-end">
            @if (Auth::guard('admin')->user()->can('owners.edit'))
                <a class="btn btn-add text-white" href="{{ route('admin.owners.create') }}">
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-3">
            <h3 class="pb-3">Owner History</h3>
            <div class="card">
                <div class="card-body">
                    <div class="data-tables">
                        @include('backend.layouts.partials.messages')
                        <table id="owner_index" class="table table-bordered table-striped display responsive nowrap">
    ...
    @include('backend.layouts.partials.data-table')
     ...
     <script>
        $(document).ready(function() {
            var table = $('#owner_index').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                ...
                pageLength: 10,
                ajax: "{{ route('owners.ajaxIndex') }}",
                // ajax: {
                //     url: "{{ route('owners.ajaxIndex' ) }}",
                //     type: 'GET',
                //     data: function (d) {
            ...
            table.on('xhr', function() {
                ...
                if (data.length === 0) {
                    $('#owner_index').css('width', '100%');
                } else {
                    $('#owner_index').css('width', 'auto');
                }
            });
        });
