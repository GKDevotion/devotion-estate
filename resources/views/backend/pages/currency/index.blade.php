    ...
    <div class="row align-items-center">
        <div class="col-sm-7">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left d-none">Currency</h4>
        ...
        <div class="col-md-3 text-end">
            @if (Auth::guard('admin')->user()->can('currency.create'))
                <a class="btn btn-add text-white" href="{{ route('admin.currency.create') }}">
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-3">
            <h3 class="pb-3">Currency History</h3>
            <div class="card">
                <div class="card-body">
                        ...
                        <table id="currency_index" class="text-center">
                            <thead id="currency" class="bg-light text-capitalize">
                                <tr>
                                    ...
                                    <th width="5%">Currency Value 1 AED</th>
     ...
     <script>
        $(document).ready(function() {
            $('#currency_index').DataTable({
                ...
                pageLength: 10,
                ajax: "{{ route('currency.ajaxIndex') }}",
                columns: [
                    { data: 'id', name: 'id' },
                    { data: 'name', name: 'name' },
                    { data: 'currency_code', name: 'currency_code' },
                    { data: 'currency_value', name: 'currency_value' },
