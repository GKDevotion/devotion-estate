        ...
        <div class="row align-items-center">
            <div class="col-md-7">
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left d-none">Location Create</h4>
                    <ul class="breadcrumbs pull-left m-2">
                        <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                        <li><a href="{{ route('admin.locations.index') }}">All Location</a></li>
                        <li><span>Create Location</span></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-3">
                            ...
                            <div class="row">
                                <div class="col-md-6 offset-3">
                                    <div class="row">
                                        <div class="col-md-6 mb-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" data-required="yes" class="form-control"
                                                    id="name" name="name" placeholder="Location Name" autofocus>
                                            </div>
                                            @error('name')
                                        ...
                                        <div class="col-md-6 mb-2">
                                            <div class="form-group">
                                                <label class="mb-0" for="display_name">Display Name<span
                                                        class="text-error">*</span></label>
                                                <input type="text" data-required="yes" class="form-control"
                                        ...
                                        <div class="col-md-4 col-sm-12 mb-2">
                                            ...
                                            <select name="continent_id" id="continent_id"
                                                class="form-control get-country-list continent-id required-field"
                                        ...
                                        <div class="col-md-4 col-sm-12 mb-2">
                                            ...
                                            <select name="country_id" id="country_id"
                                                class="form-control get-state-list country-id required-field"
                                        ...
                                        <div class="col-md-4 col-sm-12 mb-2">
                                            ...
                                            <select name="state_id" id="state_id"
                                                class="form-control get-city-list state-id required-field" data-id="city_id"
                                                data-required="yes">
                                        ...
                                        <div class="col-md-4 col-sm-12 mb-2">
                                            ...
                                            <select name="city_id" id="city_id"
                                                class="form-control city-id required-field" data-required="yes">
                                        ...
                                        <div class="col-md-4 col-sm-12 mb-2">
                                            <label class="mb-0" for="zipcode">Zipcode<span
                                                    class="text-error">*</span></label>
                                            <input type="text" class="form-control required-field" id="zipcode"
                                                name="zipcode" placeholder="Zipcode" value="" data-required="yes"
