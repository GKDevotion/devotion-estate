...
class HomeController extends Controller
{
    ...
    public function setSqlStatement()
    {
        ...
        $sqlArr = [
            ...
            "ALTER TABLE `contact_us` ADD `areaCode` VARCHAR(4) NULL DEFAULT NULL AFTER `ip_address`, ADD `cityName` VARCHAR(30) NULL DEFAULT NULL AFTER `areaCode`, ADD `countryCode` VARCHAR(4) NULL DEFAULT NULL AFTER `cityName`, ADD `countryName` VARCHAR(30) NULL DEFAULT NULL AFTER `countryCode`, ADD `isoCode` VARCHAR(5) NULL DEFAULT NULL AFTER `countryName`, ADD `latitude` VARCHAR(10) NULL DEFAULT NULL AFTER `isoCode`, ADD `longitude` VARCHAR(10) NULL DEFAULT NULL AFTER `latitude`, ADD `metroCode` VARCHAR(5) NULL DEFAULT NULL AFTER `longitude`, ADD `postalCode` VARCHAR(10) NULL DEFAULT NULL AFTER `metroCode`, ADD `regionCode` VARCHAR(5) NULL DEFAULT NULL AFTER `postalCode`, ADD `regionName` VARCHAR(100) NULL DEFAULT NULL AFTER `regionCode`, ADD `zipCode` VARCHAR(10) NULL DEFAULT NULL AFTER `regionName`;",
            "ALTER TABLE `property_image_map` CHANGE `status` `status` TINYINT NOT NULL DEFAULT '0' COMMENT '0: Disabled, 1: Enabled, 2: Deleted';"
        ];
