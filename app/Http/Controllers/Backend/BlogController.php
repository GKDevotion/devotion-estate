...
class BlogController extends Controller
{
    ...
    public function ajaxIndex( Request $request ){
        ...
        $query->select('id', 'image', 'title', 'category_id', 'updated_at', 'status');
        ...
        return DataTables::eloquent($query)
            ...
            ->addColumn('action', function(Blog $ar ) {
                ...
                $action = '
                    ...
                    if ($this->user->can('blogs.edit')) {
                        $action.= '<a class="btn btn-edit text-white dropdown-item" href="'.route('admin.blogs.edit', $ar->id).'">
                            <i class="fa fa-pencil"></i> Edit
                        </a>';
                    }

                    if ($this->user->can('blogs.delete')) {
                        $action.= '<button class="btn btn-edit text-white dropdown-item delete-record" data-id="'.$ar->id.'" data-title="'.$ar->category_id.'" data-segment="locations">
            ...
            ->rawColumns(['id','image', 'title', 'category_id', 'updated_at', 'status', 'action'])  // Specify the columns that contain HTML
    ...
    public function create()
    {
        ...
        return view('backend.pages.blog.create', compact('continentObj'));
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('backend.pages.blog.edit', compact('data', 'continentObj', 'countryObj', 'stateObj', 'cityObj'));
    }
